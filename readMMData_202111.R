...
#Proper column names
properColNames <- c("file_path","lane_ID","cell_ID","frame","cell_rank","genealogy","type_of_end","parent_ID","cells_in_lane","bbox_top_px","bbox_bottom_px","center_x_px","center_y_px","width_px","length_px","tilt_rad","area_px","bgmask_area_px","fluo_cellmask_ch_1","fluo_bgmask_ch_1","fluo_ampl_ch_1","fluo_bg_ch_1","cell_rank")
